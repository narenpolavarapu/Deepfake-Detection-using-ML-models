...
def evaluate_model(model, test_loader, criterion, device):
    ...
    return avg_test_loss, test_accuracy, testing_time


# Evaluate the model on the test dataset
test_loss, test_accuracy, testing_time = evaluate_model(combined_model, test_loader, criterion, device)

# Print the test loss, accuracy, and testing time
print(f"Test Loss: {test_loss:.4f}, Test Accuracy: {test_accuracy:.4f}, Testing Time: {testing_time:.2f} seconds")
